...
if (isset($_SESSION['username'])) {
    ...
    $static = statics($conn, $_SESSION['username']);
} else {
          ...
          <div class="sidebar-menu">
            <ul class="menu">
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="component-accordion.php" class="submenu-link"
                      >Accordion</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-alert.php" class="submenu-link"
                      >Alert</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-badge.php" class="submenu-link"
                      >Badge</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-breadcrumb.php" class="submenu-link"
                      >Breadcrumb</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-button.php" class="submenu-link"
                      >Button</a
                    >
                  </li>
                  ...
                  <li class="submenu-item">
                    <a href="component-carousel.php" class="submenu-link"
                      >Carousel</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-collapse.php" class="submenu-link"
                      >Collapse</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-dropdown.php" class="submenu-link"
                      >Dropdown</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-list-group.php" class="submenu-link"
                      >List Group</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-modal.php" class="submenu-link"
                      >Modal</a
                    >
                  </li>
                  ...
                  <li class="submenu-item">
                    <a href="component-pagination.php" class="submenu-link"
                      >Pagination</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-placeholder.php" class="submenu-link"
                      >Placeholder</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-progress.php" class="submenu-link"
                      >Progress</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-spinner.php" class="submenu-link"
                      >Spinner</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-toasts.php" class="submenu-link"
                      >Toasts</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="component-tooltip.php" class="submenu-link"
                      >Tooltip</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="extra-component-avatar.php" class="submenu-link"
                      >Avatar</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="extra-component-comment.php" class="submenu-link"
                      >Comment</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="extra-component-divider.php" class="submenu-link"
                      >Divider</a
                    >
                  </li>
                  ...
                  <li class="submenu-item">
                    <a
                      href="extra-component-date-picker.php"
                      class="submenu-link"
                      >Date Picker</a
                    >
                  </li>
                  ...
                  <li class="submenu-item">
                    <a href="extra-component-flag.php" class="submenu-link"
                      >Flag</a
                    >
                  </li>
                  ...
                  <li class="submenu-item">
                    <a
                      href="extra-component-sweetalert.php"
                      class="submenu-link"
                      >Sweet Alert</a
                    >
                  </li>
                  ...
                  <li class="submenu-item">
                    <a href="extra-component-toastify.php" class="submenu-link"
                      >Toastify</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="extra-component-rating.php" class="submenu-link"
                      >Rating</a
                    >
                  </li>
                  ...
                  <li class="submenu-item">
                    <a
                      href="extra-component-glightbox.php"
                      class="submenu-link"
                      >GLightbox</a
                    >
                  </li>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="layout-default.php" class="submenu-link"
                      >Default Layout</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="layout-vertical-1-column.php" class="submenu-link"
                      >1 Column</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="layout-vertical-navbar.php" class="submenu-link"
                      >Vertical Navbar</a
                    >
                  </li>
                  ...
                  <li class="submenu-item">
                    <a href="layout-horizontal.php" class="submenu-link"
                      >Horizontal Menu</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="form-element-input.php" class="submenu-link"
                      >Input</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="form-element-input-group.php" class="submenu-link"
                      >Input Group</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="form-element-select.php" class="submenu-link"
                      >Select</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="form-element-radio.php" class="submenu-link"
                      >Radio</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="form-element-checkbox.php" class="submenu-link"
                      >Checkbox</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="form-element-textarea.php" class="submenu-link"
                      >Textarea</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="form-validation-parsley.php" class="submenu-link"
                      >Parsley</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="form-editor-quill.php" class="submenu-link"
                      >Quill</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="form-editor-ckeditor.php" class="submenu-link"
                      >CKEditor</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="form-editor-summernote.php" class="submenu-link"
                      >Summernote</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="form-editor-tinymce.php" class="submenu-link"
                      >TinyMCE</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="table-datatable.php" class="submenu-link"
                      >Datatable</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="table-datatable-jquery.php" class="submenu-link"
                      >Datatable (jQuery)</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="ui-widgets-chatbox.php" class="submenu-link"
                      >Chatbox</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="ui-widgets-pricing.php" class="submenu-link"
                      >Pricing</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="ui-widgets-todolist.php" class="submenu-link"
                      >To-do List</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="ui-icons-bootstrap-icons.php" class="submenu-link"
                      >Bootstrap Icons
                    </a>
                  </li>

                  <li class="submenu-item">
                    <a href="ui-icons-fontawesome.php" class="submenu-link"
                      >Fontawesome</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="ui-icons-dripicons.php" class="submenu-link"
                      >Dripicons</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="ui-chart-chartjs.php" class="submenu-link"
                      >ChartJS</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="ui-chart-apexcharts.php" class="submenu-link"
                      >Apexcharts</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="ui-map-google-map.php" class="submenu-link"
                      >Google Map</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="ui-map-jsvectormap.php" class="submenu-link"
                      >JS Vector Map</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="ui-map-leaflet.php" class="submenu-link"
                      >Leaflet Map</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="ui-map-openlayers.php" class="submenu-link"
                      >OpenLayers Map</a
                    >
                  </li>
                </ul>
                ...
                <ul class="submenu">
                  <li class="submenu-item has-sub">
                    ...
                    <ul class="submenu submenu-level-2">
                      <li class="submenu-item">
                        <a href="ui-multi-level-menu.php" class="submenu-link"
                          >Second Level</a
                        >
                      </li>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="account-profile.php" class="submenu-link"
                      >Profile</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="account-security.php" class="submenu-link"
                      >Security</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  ...
                  <li class="submenu-item">
                    <a href="auth-register.php" class="submenu-link"
                      >Register</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="auth-forgot-password.php" class="submenu-link"
                      >Forgot Password</a
                    >
                  </li>
                </ul>
                    ...
                    <div class="card-body px-4 py-4-5">
                      <div class="row">
                        ...
                        <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                          ...
                          <h6 class="font-extrabold mb-0"><?php echo $static['total'] ?></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card-body px-4 py-4-5">
                      <div class="row">
                        ...
                        <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                          ...
                          <h6 class="font-extrabold mb-0"><?php echo $static['comments'] ?></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card">
                    <div class="card-body px-4 py-4-5">
                      <div class="row">
                        ...
                        <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                          <h6 class="text-muted font-semibold">Arhcived Posts</h6>
                          <h6 class="font-extrabold mb-0"><?php echo $static['archived'] ?></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card">
                    <div class="card-body px-4 py-4-5">
                      <div class="row">
                        ...
                        <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                          <h6 class="text-muted font-semibold">Published posts</h6>
                          <h6 class="font-extrabold mb-0"><?php echo $static['published'] ?></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-hover table-lg">
                          ...
                          <tbody>
                            <?php foreach($conn-> query("SELECT * FROM comment JOIN article ON comment.articleId = article.articleId WHERE article.username = '" . $_SESSION['username'] . "' order by comment.creation_date desc") -> fetchAll() as $comment):?>
                            <tr>
                              <td class="col-3">
                                <div class="d-flex align-items-center">
                                  ...
                                  <p class="font-bold ms-3 mb-0"><?php echo $comment['username'] ?></p>
                                </div>
                              </td>
                              <td class="col-auto">
                                <p class="mb-0">
          ...
          <div class="footer clearfix mb-0 text-muted">
            ...
            <div class="float-end">
              <p>
                ...
                ></span>
                by
                <a href="https://github.com/zuramai" target="_blank">Saugi</a>
                distributed by
